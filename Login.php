...
<body>
    ...
    <div class="DivContainerLeft">
        ...
        <a class="Button" href="php/TArticulos.php">Articulos</a>
        <a class="Button" href="php/TVentas.php">Ventas</a>
        <a class="Button" href="php/TEmpleados.php">Empleados</a>
        <a class="Button" href="php/TIncidencias.php">Incidencias</a>
